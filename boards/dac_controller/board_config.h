...
#define VENDOR_NAME "49 Laboratories"
#define PRODUCT_NAME "DAC audio controller board"
#define VOLUME_LABEL "DACBOOT"
#define INDEX_URL "https://github.com/whatkidyou/uf2_DAC_board"
